...
Если в качестве оболочки для консоли вы используете fish, для быстрой сборки и запуска проекта можно применить функцию из файла `/fish-functions/c++run.fish`. Для этого добавьте этот файл в папку `.config/fish/function` и в каталоге на уровень выше папки с проектом, вызовете команду `c++run <Название папки с проектом>`
